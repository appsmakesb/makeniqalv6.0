...
public final class ConfirmbankBinding implements ViewBinding {
  @NonNull
  ...
  private ConfirmbankBinding(@NonNull LinearLayout rootView, @NonNull Button btnNo,
  ...
  @NonNull
  public static ConfirmbankBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ConfirmbankBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.confirmbank, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ConfirmbankBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ConfirmbankBinding((LinearLayout) rootView, btnNo, btnYes, camount, cnumber, cop,
          ctype);
    }
