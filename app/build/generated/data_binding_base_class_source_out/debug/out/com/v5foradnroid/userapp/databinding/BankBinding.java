...
public final class BankBinding implements ViewBinding {
  ...
  private BankBinding(@NonNull LinearLayout rootView, @NonNull EditText amount,
  ...
  public static BankBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BankBinding((LinearLayout) rootView, amount, branch, error, flot, mainlayout, name,
          number, pin, remark, sub);
    }
