...
public final class MyprofileBinding implements ViewBinding {
  ...
  private MyprofileBinding(@NonNull LinearLayout rootView, @NonNull EditText address,
  ...
  public static MyprofileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MyprofileBinding((LinearLayout) rootView, address, aname, birth, email, error,
          nick, nid, opin, phn, reg);
    }
