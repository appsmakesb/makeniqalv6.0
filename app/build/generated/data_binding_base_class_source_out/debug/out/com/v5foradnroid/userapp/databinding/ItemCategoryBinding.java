...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull MaterialRippleLayout rootView,
      @NonNull ImageView categoryImage, @NonNull TextView categoryName,
      @NonNull TextView productCount) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.product_count;
      TextView productCount = ViewBindings.findChildViewById(rootView, id);
      if (productCount == null) {
        break missingId;
      }

      return new ItemCategoryBinding((MaterialRippleLayout) rootView, categoryImage, categoryName,
          productCount);
    }
