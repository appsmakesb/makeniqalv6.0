...
public final class ConfirmBinding implements ViewBinding {
  @NonNull
  ...
  private ConfirmBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout addbalance,
      @NonNull LinearLayout ads, @NonNull TextView camount, @NonNull TextView cnumber,
      @NonNull TextView ctype, @NonNull RelativeLayout hd,
      @NonNull ProgressBar horizontalProgressBar, @NonNull ImageView opera,
      @NonNull FrameLayout operator, @NonNull LinearLayout sendmoney, @NonNull RelativeLayout tap) {
  ...
  @NonNull
  public static ConfirmBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ConfirmBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.confirm, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ConfirmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tap;
      RelativeLayout tap = ViewBindings.findChildViewById(rootView, id);
      if (tap == null) {
        break missingId;
      }

      return new ConfirmBinding((LinearLayout) rootView, addbalance, ads, camount, cnumber, ctype,
          hd, horizontalProgressBar, opera, operator, sendmoney, tap);
    }
