...
public final class ActivityProductDetailBinding implements ViewBinding {
  ...
  private ActivityProductDetailBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RelativeLayout lytCheckout, @NonNull CoordinatorLayout mainContent,
      @NonNull WebView productDescription, @NonNull ImageView productImage,
      @NonNull TextView productName, @NonNull TextView productPrice,
      @NonNull TextView productQuantity, @NonNull NestedScrollView sclDetail,
  ...
  public static ActivityProductDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductDetailBinding((RelativeLayout) rootView, appbar, btnAddCart,
          collapsingToolbar, cv, lytCheckout, mainContent, productDescription, productImage,
          productName, productPrice, productQuantity, sclDetail, toolbar);
    }
